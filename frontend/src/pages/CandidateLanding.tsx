...
export default function CandidateLanding() {
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="w-full max-w-sm text-center">
          ...
          <h1 className="text-2xl font-semibold text-dark mb-2">Simulation Complete</h1>
          <p className="text-muted text-sm mb-6">
            Thank you, {context.candidate_name}! You've already completed this simulation.
          </p>
          <a
            href={`/report/${sessionId}/candidate`}
            className="inline-block bg-dark text-white py-3 px-6 rounded-full font-medium text-sm hover:opacity-85 transition-all"
          >
            View Your Report
          </a>
        </div>
  ...
  // Handle in-progress sessions - allow them to continue
      ...
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="w-full max-w-sm text-center">
          ...
          <p className="text-mid text-sm leading-relaxed mb-8">
            Welcome back, <span className="font-medium">{context.candidate_name}</span>.
            You have a simulation in progress. Continue where you left off.
          </p>
